...
import { addCustomBackground } from "../../features/graph-editor/components/custom-background/background";
...
export class GraphEditorService {
  ...
  private editorSource: BehaviorSubject<string> = new BehaviorSubject<string>(
    "General Editor"
  );
  private anyChangeSource: BehaviorSubject<string> =
